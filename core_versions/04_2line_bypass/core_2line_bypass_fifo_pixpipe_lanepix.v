...
reg        pix_valid;
reg [7:0]  pix_t0 [0:2], pix_t1 [0:2], pix_t2 [0:2], pix_t3 [0:2];
reg [7:0]  pix_m0 [0:2], pix_m1 [0:2], pix_m2 [0:2], pix_m3 [0:2];
reg [7:0]  pix_b0 [0:2], pix_b1 [0:2], pix_b2 [0:2], pix_b3 [0:2];
...
task push_group_2line;
    ...
    begin
        ...
        pix_t0[0] <= t0;  pix_t0[1] <= t1;  pix_t0[2] <= t2;
        pix_t1[0] <= t1;  pix_t1[1] <= t2;  pix_t1[2] <= t3;
        pix_t2[0] <= t2;  pix_t2[1] <= t3;  pix_t2[2] <= t4;
        pix_t3[0] <= t3;  pix_t3[1] <= t4;  pix_t3[2] <= t5;
        pix_m0[0] <= m0;  pix_m0[1] <= m1;  pix_m0[2] <= m2;
        pix_m1[0] <= m1;  pix_m1[1] <= m2;  pix_m1[2] <= m3;
        pix_m2[0] <= m2;  pix_m2[1] <= m3;  pix_m2[2] <= m4;
        pix_m3[0] <= m3;  pix_m3[1] <= m4;  pix_m3[2] <= m5;
        pix_b0[0] <= bb0; pix_b0[1] <= bb1; pix_b0[2] <= bb2;
        pix_b1[0] <= bb1; pix_b1[1] <= bb2; pix_b1[2] <= bb3;
        pix_b2[0] <= bb2; pix_b2[1] <= bb3; pix_b2[2] <= bb4;
        pix_b3[0] <= bb3; pix_b3[1] <= bb4; pix_b3[2] <= bb5;
    end
endtask
...
task push_group_2line_s2;
    ...
    begin
        ...
        pix_t0[0] <= t0;  pix_t0[1] <= t1;  pix_t0[2] <= t2;
        pix_t1[0] <= t2;  pix_t1[1] <= t3;  pix_t1[2] <= t4;
        pix_t2[0] <= t4;  pix_t2[1] <= t5;  pix_t2[2] <= t6;
        pix_t3[0] <= t6;  pix_t3[1] <= t7;  pix_t3[2] <= t8;
        pix_m0[0] <= m0;  pix_m0[1] <= m1;  pix_m0[2] <= m2;
        pix_m1[0] <= m2;  pix_m1[1] <= m3;  pix_m1[2] <= m4;
        pix_m2[0] <= m4;  pix_m2[1] <= m5;  pix_m2[2] <= m6;
        pix_m3[0] <= m6;  pix_m3[1] <= m7;  pix_m3[2] <= m8;
        pix_b0[0] <= bb0; pix_b0[1] <= bb1; pix_b0[2] <= bb2;
        pix_b1[0] <= bb2; pix_b1[1] <= bb3; pix_b1[2] <= bb4;
        pix_b2[0] <= bb4; pix_b2[1] <= bb5; pix_b2[2] <= bb6;
        pix_b3[0] <= bb6; pix_b3[1] <= bb7; pix_b3[2] <= bb8;
    end
endtask
...
always @(posedge i_clk or negedge i_rst_n) begin
    if (!i_rst_n) begin
        ...
        if (pix_valid) begin
            sum_valid <= 1'b1;
            sum_a0 <= row_sum3(mul_pixel_weight(pix_t0[0], w0), mul_pixel_weight(pix_t0[1], w1), mul_pixel_weight(pix_t0[2], w2));
            sum_b0 <= row_sum3(mul_pixel_weight(pix_m0[0], w3), mul_pixel_weight(pix_m0[1], w4), mul_pixel_weight(pix_m0[2], w5));
            sum_c0 <= row_sum3(mul_pixel_weight(pix_b0[0], w6), mul_pixel_weight(pix_b0[1], w7), mul_pixel_weight(pix_b0[2], w8));
            sum_a1 <= row_sum3(mul_pixel_weight(pix_t1[0], w0), mul_pixel_weight(pix_t1[1], w1), mul_pixel_weight(pix_t1[2], w2));
            sum_b1 <= row_sum3(mul_pixel_weight(pix_m1[0], w3), mul_pixel_weight(pix_m1[1], w4), mul_pixel_weight(pix_m1[2], w5));
            sum_c1 <= row_sum3(mul_pixel_weight(pix_b1[0], w6), mul_pixel_weight(pix_b1[1], w7), mul_pixel_weight(pix_b1[2], w8));
            sum_a2 <= row_sum3(mul_pixel_weight(pix_t2[0], w0), mul_pixel_weight(pix_t2[1], w1), mul_pixel_weight(pix_t2[2], w2));
            sum_b2 <= row_sum3(mul_pixel_weight(pix_m2[0], w3), mul_pixel_weight(pix_m2[1], w4), mul_pixel_weight(pix_m2[2], w5));
            sum_c2 <= row_sum3(mul_pixel_weight(pix_b2[0], w6), mul_pixel_weight(pix_b2[1], w7), mul_pixel_weight(pix_b2[2], w8));
            sum_a3 <= row_sum3(mul_pixel_weight(pix_t3[0], w0), mul_pixel_weight(pix_t3[1], w1), mul_pixel_weight(pix_t3[2], w2));
            sum_b3 <= row_sum3(mul_pixel_weight(pix_m3[0], w3), mul_pixel_weight(pix_m3[1], w4), mul_pixel_weight(pix_m3[2], w5));
            sum_c3 <= row_sum3(mul_pixel_weight(pix_b3[0], w6), mul_pixel_weight(pix_b3[1], w7), mul_pixel_weight(pix_b3[2], w8));
        end
