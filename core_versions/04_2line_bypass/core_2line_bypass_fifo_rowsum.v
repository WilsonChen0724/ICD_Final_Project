...
task push_group_2line;
    ...
    begin
        ...
        sum_c0 <= row_sum3(mul_pixel_weight(bb0, w6), mul_pixel_weight(bb1, w7), mul_pixel_weight(bb2, w8));
        ...
        sum_c1 <= row_sum3(mul_pixel_weight(bb1, w6), mul_pixel_weight(bb2, w7), mul_pixel_weight(bb3, w8));
        ...
        sum_c2 <= row_sum3(mul_pixel_weight(bb2, w6), mul_pixel_weight(bb3, w7), mul_pixel_weight(bb4, w8));
        ...
        sum_c3 <= row_sum3(mul_pixel_weight(bb3, w6), mul_pixel_weight(bb4, w7), mul_pixel_weight(bb5, w8));
    end
endtask
...
task push_group_2line_s2;
    ...
    begin
        ...
        sum_b0 <= row_sum3(mul_pixel_weight(m0, w3), mul_pixel_weight(m1, w4), mul_pixel_weight(m2, w5));
        sum_c0 <= row_sum3(mul_pixel_weight(bb0, w6), mul_pixel_weight(bb1, w7), mul_pixel_weight(bb2, w8));
        sum_a1 <= row_sum3(mul_pixel_weight(t2, w0), mul_pixel_weight(t3, w1), mul_pixel_weight(t4, w2));
        sum_b1 <= row_sum3(mul_pixel_weight(m2, w3), mul_pixel_weight(m3, w4), mul_pixel_weight(m4, w5));
        sum_c1 <= row_sum3(mul_pixel_weight(bb2, w6), mul_pixel_weight(bb3, w7), mul_pixel_weight(bb4, w8));
        sum_a2 <= row_sum3(mul_pixel_weight(t4, w0), mul_pixel_weight(t5, w1), mul_pixel_weight(t6, w2));
        sum_b2 <= row_sum3(mul_pixel_weight(m4, w3), mul_pixel_weight(m5, w4), mul_pixel_weight(m6, w5));
        sum_c2 <= row_sum3(mul_pixel_weight(bb4, w6), mul_pixel_weight(bb5, w7), mul_pixel_weight(bb6, w8));
        sum_a3 <= row_sum3(mul_pixel_weight(t6, w0), mul_pixel_weight(t7, w1), mul_pixel_weight(t8, w2));
        sum_b3 <= row_sum3(mul_pixel_weight(m6, w3), mul_pixel_weight(m7, w4), mul_pixel_weight(m8, w5));
        sum_c3 <= row_sum3(mul_pixel_weight(bb6, w6), mul_pixel_weight(bb7, w7), mul_pixel_weight(bb8, w8));
    end
endtask
