...
function [10:0] square_u6_shiftadd;
    input [5:0] x;
    reg [10:0] pp0, pp1, pp2, pp3, pp4, pp5;
    reg [10:0] s0, s1, s2;
    begin
        pp0 = x[0] ? {5'd0, x}          : 11'd0;
        pp1 = x[1] ? ({5'd0, x} << 1)   : 11'd0;
        pp2 = x[2] ? ({5'd0, x} << 2)   : 11'd0;
        pp3 = x[3] ? ({5'd0, x} << 3)   : 11'd0;
        pp4 = x[4] ? ({5'd0, x} << 4)   : 11'd0;
        pp5 = x[5] ? ({5'd0, x} << 5)   : 11'd0;
        s0 = pp0 + pp1;
        s1 = pp2 + pp3;
        s2 = pp4 + pp5;
        square_u6_shiftadd = s0 + s1 + s2;
    end
endfunction

function [15:0] cube_u6_shiftadd;
    input [5:0] x;
    reg [10:0] x2;
    reg [15:0] pp0, pp1, pp2, pp3, pp4, pp5;
    reg [15:0] s0, s1, s2;
    begin
        x2 = square_u6_shiftadd(x);
        pp0 = x[0] ? {5'd0, x2}          : 16'd0;
        pp1 = x[1] ? ({5'd0, x2} << 1)   : 16'd0;
        pp2 = x[2] ? ({5'd0, x2} << 2)   : 16'd0;
        pp3 = x[3] ? ({5'd0, x2} << 3)   : 16'd0;
        pp4 = x[4] ? ({5'd0, x2} << 4)   : 16'd0;
        pp5 = x[5] ? ({5'd0, x2} << 5)   : 16'd0;
        s0 = pp0 + pp1;
        s1 = pp2 + pp3;
        s2 = pp4 + pp5;
        cube_u6_shiftadd = s0 + s1 + s2;
    end
endfunction
