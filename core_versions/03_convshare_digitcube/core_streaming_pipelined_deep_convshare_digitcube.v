...
reg        mac_valid;
reg signed [16:0] mac_prod0 [0:8], mac_prod1 [0:8], mac_prod2 [0:8], mac_prod3 [0:8];
...
task push_group;
    ...
    begin
        ...
        if (!stride_reg) begin
            ...
            mac_prod0[6] <= mul_pixel_weight(b0, w6);
            mac_prod0[7] <= mul_pixel_weight(b1, w7);
            mac_prod0[8] <= mul_pixel_weight(b2, w8);
            ...
            mac_prod1[6] <= mul_pixel_weight(b1, w6);
            mac_prod1[7] <= mul_pixel_weight(b2, w7);
            mac_prod1[8] <= mul_pixel_weight(b3, w8);
            ...
            mac_prod2[6] <= mul_pixel_weight(b2, w6);
            mac_prod2[7] <= mul_pixel_weight(b3, w7);
            mac_prod2[8] <= mul_pixel_weight(b4, w8);
            ...
            mac_prod3[6] <= mul_pixel_weight(b3, w6);
            mac_prod3[7] <= mul_pixel_weight(b4, w7);
            mac_prod3[8] <= mul_pixel_weight(b5, w8);
        end else begin
            c0 = {out_c_base, 1'b0};
...
always @(posedge i_clk or negedge i_rst_n) begin
    if (!i_rst_n) begin
        ...
        if (mac_valid) begin
            sum_valid <= 1'b1;
            sum_a0 <= row_sum3(mac_prod0[0], mac_prod0[1], mac_prod0[2]);
            sum_b0 <= row_sum3(mac_prod0[3], mac_prod0[4], mac_prod0[5]);
            sum_c0 <= row_sum3(mac_prod0[6], mac_prod0[7], mac_prod0[8]);
            sum_a1 <= row_sum3(mac_prod1[0], mac_prod1[1], mac_prod1[2]);
            sum_b1 <= row_sum3(mac_prod1[3], mac_prod1[4], mac_prod1[5]);
            sum_c1 <= row_sum3(mac_prod1[6], mac_prod1[7], mac_prod1[8]);
            sum_a2 <= row_sum3(mac_prod2[0], mac_prod2[1], mac_prod2[2]);
            sum_b2 <= row_sum3(mac_prod2[3], mac_prod2[4], mac_prod2[5]);
            sum_c2 <= row_sum3(mac_prod2[6], mac_prod2[7], mac_prod2[8]);
            sum_a3 <= row_sum3(mac_prod3[0], mac_prod3[1], mac_prod3[2]);
            sum_b3 <= row_sum3(mac_prod3[3], mac_prod3[4], mac_prod3[5]);
            sum_c3 <= row_sum3(mac_prod3[6], mac_prod3[7], mac_prod3[8]);
