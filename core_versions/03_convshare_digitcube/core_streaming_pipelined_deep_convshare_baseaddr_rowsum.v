...
reg        mac_valid;
reg signed [19:0] mac_a0, mac_b0, mac_c0;
reg signed [19:0] mac_a1, mac_b1, mac_c1;
reg signed [19:0] mac_a2, mac_b2, mac_c2;
reg signed [19:0] mac_a3, mac_b3, mac_c3;
...
task push_group;
    ...
    begin
        ...
        if (!stride_reg) begin
            ...
            mac_a0 <= mul_pixel_weight(t0, w0) + mul_pixel_weight(t1, w1) + mul_pixel_weight(t2, w2);
            mac_b0 <= mul_pixel_weight(m0, w3) + mul_pixel_weight(m1, w4) + mul_pixel_weight(m2, w5);
            mac_c0 <= mul_pixel_weight(b0, w6) + mul_pixel_weight(b1, w7) + mul_pixel_weight(b2, w8);

            mac_a1 <= mul_pixel_weight(t1, w0) + mul_pixel_weight(t2, w1) + mul_pixel_weight(t3, w2);
            mac_b1 <= mul_pixel_weight(m1, w3) + mul_pixel_weight(m2, w4) + mul_pixel_weight(m3, w5);
            mac_c1 <= mul_pixel_weight(b1, w6) + mul_pixel_weight(b2, w7) + mul_pixel_weight(b3, w8);

            mac_a2 <= mul_pixel_weight(t2, w0) + mul_pixel_weight(t3, w1) + mul_pixel_weight(t4, w2);
            mac_b2 <= mul_pixel_weight(m2, w3) + mul_pixel_weight(m3, w4) + mul_pixel_weight(m4, w5);
            mac_c2 <= mul_pixel_weight(b2, w6) + mul_pixel_weight(b3, w7) + mul_pixel_weight(b4, w8);

            mac_a3 <= mul_pixel_weight(t3, w0) + mul_pixel_weight(t4, w1) + mul_pixel_weight(t5, w2);
            mac_b3 <= mul_pixel_weight(m3, w3) + mul_pixel_weight(m4, w4) + mul_pixel_weight(m5, w5);
            mac_c3 <= mul_pixel_weight(b3, w6) + mul_pixel_weight(b4, w7) + mul_pixel_weight(b5, w8);
        end else begin
            c0 = {out_c_base, 1'b0};
            ...
            mac_a0 <= calc_product(center_r, c0, 4'd0) + calc_product(center_r, c0, 4'd1) + calc_product(center_r, c0, 4'd2);
            mac_b0 <= calc_product(center_r, c0, 4'd3) + calc_product(center_r, c0, 4'd4) + calc_product(center_r, c0, 4'd5);
            mac_c0 <= calc_product(center_r, c0, 4'd6) + calc_product(center_r, c0, 4'd7) + calc_product(center_r, c0, 4'd8);
            mac_a1 <= calc_product(center_r, c1, 4'd0) + calc_product(center_r, c1, 4'd1) + calc_product(center_r, c1, 4'd2);
            mac_b1 <= calc_product(center_r, c1, 4'd3) + calc_product(center_r, c1, 4'd4) + calc_product(center_r, c1, 4'd5);
            mac_c1 <= calc_product(center_r, c1, 4'd6) + calc_product(center_r, c1, 4'd7) + calc_product(center_r, c1, 4'd8);
            mac_a2 <= calc_product(center_r, c2, 4'd0) + calc_product(center_r, c2, 4'd1) + calc_product(center_r, c2, 4'd2);
            mac_b2 <= calc_product(center_r, c2, 4'd3) + calc_product(center_r, c2, 4'd4) + calc_product(center_r, c2, 4'd5);
            mac_c2 <= calc_product(center_r, c2, 4'd6) + calc_product(center_r, c2, 4'd7) + calc_product(center_r, c2, 4'd8);
            mac_a3 <= calc_product(center_r, c3, 4'd0) + calc_product(center_r, c3, 4'd1) + calc_product(center_r, c3, 4'd2);
            mac_b3 <= calc_product(center_r, c3, 4'd3) + calc_product(center_r, c3, 4'd4) + calc_product(center_r, c3, 4'd5);
            mac_c3 <= calc_product(center_r, c3, 4'd6) + calc_product(center_r, c3, 4'd7) + calc_product(center_r, c3, 4'd8);
        end
