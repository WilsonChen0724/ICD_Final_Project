...
task push_group;
    ...
    reg signed [7:0] cr;
    reg signed [7:0] cc;
    reg [5:0] row_t, row_m, row_b;
    reg [5:0] col_m1, col_0, col_1, col_2, col_3, col_4;
    ...
    begin
        ...
        if (!stride_reg) begin
            ...
            if ((center_r != 7'd0) && (center_r != 7'd63) &&
                (out_c_base != 6'd0) && (out_c_base != 6'd60)) begin
                row_t = center_r[5:0] - 6'd1;
                row_m = center_r[5:0];
                row_b = center_r[5:0] + 6'd1;
                col_m1 = out_c_base - 6'd1;
                col_0 = out_c_base;
                col_1 = out_c_base + 6'd1;
                col_2 = out_c_base + 6'd2;
                col_3 = out_c_base + 6'd3;
                col_4 = out_c_base + 6'd4;

                t0 = get_pixel_raw(row_t, col_m1);
                t1 = get_pixel_raw(row_t, col_0);
                t2 = get_pixel_raw(row_t, col_1);
                t3 = get_pixel_raw(row_t, col_2);
                t4 = get_pixel_raw(row_t, col_3);
                t5 = get_pixel_raw(row_t, col_4);

                m0 = get_pixel_raw(row_m, col_m1);
                m1 = get_pixel_raw(row_m, col_0);
                m2 = get_pixel_raw(row_m, col_1);
                m3 = get_pixel_raw(row_m, col_2);
                m4 = get_pixel_raw(row_m, col_3);
                m5 = get_pixel_raw(row_m, col_4);

                b0 = get_pixel_raw(row_b, col_m1);
                b1 = get_pixel_raw(row_b, col_0);
                b2 = get_pixel_raw(row_b, col_1);
                b3 = get_pixel_raw(row_b, col_2);
                b4 = get_pixel_raw(row_b, col_3);
                b5 = get_pixel_raw(row_b, col_4);
            end else begin
                t0 = get_pixel(cr - 8'sd1, cc - 8'sd1);
                t1 = get_pixel(cr - 8'sd1, cc);
                t2 = get_pixel(cr - 8'sd1, cc + 8'sd1);
                t3 = get_pixel(cr - 8'sd1, cc + 8'sd2);
                t4 = get_pixel(cr - 8'sd1, cc + 8'sd3);
                t5 = get_pixel(cr - 8'sd1, cc + 8'sd4);

                m0 = get_pixel(cr, cc - 8'sd1);
                m1 = get_pixel(cr, cc);
                m2 = get_pixel(cr, cc + 8'sd1);
                m3 = get_pixel(cr, cc + 8'sd2);
                m4 = get_pixel(cr, cc + 8'sd3);
                m5 = get_pixel(cr, cc + 8'sd4);

                b0 = get_pixel(cr + 8'sd1, cc - 8'sd1);
                b1 = get_pixel(cr + 8'sd1, cc);
                b2 = get_pixel(cr + 8'sd1, cc + 8'sd1);
                b3 = get_pixel(cr + 8'sd1, cc + 8'sd2);
                b4 = get_pixel(cr + 8'sd1, cc + 8'sd3);
                b5 = get_pixel(cr + 8'sd1, cc + 8'sd4);
            end

            sum_a0 <= row_sum3(mul_pixel_weight(t0, w0), mul_pixel_weight(t1, w1), mul_pixel_weight(t2, w2));
            sum_b0 <= row_sum3(mul_pixel_weight(m0, w3), mul_pixel_weight(m1, w4), mul_pixel_weight(m2, w5));
            sum_c0 <= row_sum3(mul_pixel_weight(b0, w6), mul_pixel_weight(b1, w7), mul_pixel_weight(b2, w8));
            sum_a1 <= row_sum3(mul_pixel_weight(t1, w0), mul_pixel_weight(t2, w1), mul_pixel_weight(t3, w2));
            sum_b1 <= row_sum3(mul_pixel_weight(m1, w3), mul_pixel_weight(m2, w4), mul_pixel_weight(m3, w5));
            sum_c1 <= row_sum3(mul_pixel_weight(b1, w6), mul_pixel_weight(b2, w7), mul_pixel_weight(b3, w8));
            sum_a2 <= row_sum3(mul_pixel_weight(t2, w0), mul_pixel_weight(t3, w1), mul_pixel_weight(t4, w2));
            sum_b2 <= row_sum3(mul_pixel_weight(m2, w3), mul_pixel_weight(m3, w4), mul_pixel_weight(m4, w5));
            sum_c2 <= row_sum3(mul_pixel_weight(b2, w6), mul_pixel_weight(b3, w7), mul_pixel_weight(b4, w8));
            sum_a3 <= row_sum3(mul_pixel_weight(t3, w0), mul_pixel_weight(t4, w1), mul_pixel_weight(t5, w2));
            sum_b3 <= row_sum3(mul_pixel_weight(m3, w3), mul_pixel_weight(m4, w4), mul_pixel_weight(m5, w5));
            sum_c3 <= row_sum3(mul_pixel_weight(b3, w6), mul_pixel_weight(b4, w7), mul_pixel_weight(b5, w8));
        end else begin
            c0 = {out_c_base, 1'b0};
            ...
            sum_a0 <= row_sum3(calc_product(center_r, c0, 4'd0), calc_product(center_r, c0, 4'd1), calc_product(center_r, c0, 4'd2));
            sum_b0 <= row_sum3(calc_product(center_r, c0, 4'd3), calc_product(center_r, c0, 4'd4), calc_product(center_r, c0, 4'd5));
            sum_c0 <= row_sum3(calc_product(center_r, c0, 4'd6), calc_product(center_r, c0, 4'd7), calc_product(center_r, c0, 4'd8));
            sum_a1 <= row_sum3(calc_product(center_r, c1, 4'd0), calc_product(center_r, c1, 4'd1), calc_product(center_r, c1, 4'd2));
            sum_b1 <= row_sum3(calc_product(center_r, c1, 4'd3), calc_product(center_r, c1, 4'd4), calc_product(center_r, c1, 4'd5));
            sum_c1 <= row_sum3(calc_product(center_r, c1, 4'd6), calc_product(center_r, c1, 4'd7), calc_product(center_r, c1, 4'd8));
            sum_a2 <= row_sum3(calc_product(center_r, c2, 4'd0), calc_product(center_r, c2, 4'd1), calc_product(center_r, c2, 4'd2));
            sum_b2 <= row_sum3(calc_product(center_r, c2, 4'd3), calc_product(center_r, c2, 4'd4), calc_product(center_r, c2, 4'd5));
            sum_c2 <= row_sum3(calc_product(center_r, c2, 4'd6), calc_product(center_r, c2, 4'd7), calc_product(center_r, c2, 4'd8));
            sum_a3 <= row_sum3(calc_product(center_r, c3, 4'd0), calc_product(center_r, c3, 4'd1), calc_product(center_r, c3, 4'd2));
            sum_b3 <= row_sum3(calc_product(center_r, c3, 4'd3), calc_product(center_r, c3, 4'd4), calc_product(center_r, c3, 4'd5));
            sum_c3 <= row_sum3(calc_product(center_r, c3, 4'd6), calc_product(center_r, c3, 4'd7), calc_product(center_r, c3, 4'd8));
        end
