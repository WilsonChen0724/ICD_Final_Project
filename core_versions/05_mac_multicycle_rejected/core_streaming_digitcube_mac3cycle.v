...
always @(posedge i_clk or negedge i_rst_n) begin
    if (!i_rst_n) begin
        ...
        if (mac_busy && (mac_phase == 2'd1)) begin
            mac_phase <= 2'd2;
            sum_b0 <= row_sum3(calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base, 1'b0} : {1'b0, mac_job_out_c_base}, 4'd3),
                               calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base, 1'b0} : {1'b0, mac_job_out_c_base}, 4'd4),
                               calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base, 1'b0} : {1'b0, mac_job_out_c_base}, 4'd5));
            sum_b1 <= row_sum3(calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base + 6'd1, 1'b0} : {1'b0, mac_job_out_c_base + 6'd1}, 4'd3),
                               calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base + 6'd1, 1'b0} : {1'b0, mac_job_out_c_base + 6'd1}, 4'd4),
                               calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base + 6'd1, 1'b0} : {1'b0, mac_job_out_c_base + 6'd1}, 4'd5));
            sum_b2 <= row_sum3(calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base + 6'd2, 1'b0} : {1'b0, mac_job_out_c_base + 6'd2}, 4'd3),
                               calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base + 6'd2, 1'b0} : {1'b0, mac_job_out_c_base + 6'd2}, 4'd4),
                               calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base + 6'd2, 1'b0} : {1'b0, mac_job_out_c_base + 6'd2}, 4'd5));
            sum_b3 <= row_sum3(calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base + 6'd3, 1'b0} : {1'b0, mac_job_out_c_base + 6'd3}, 4'd3),
                               calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base + 6'd3, 1'b0} : {1'b0, mac_job_out_c_base + 6'd3}, 4'd4),
                               calc_product(mac_job_center_r, stride_reg ? {mac_job_out_c_base + 6'd3, 1'b0} : {1'b0, mac_job_out_c_base + 6'd3}, 4'd5));
        end else if (mac_busy && (mac_phase == 2'd2)) begin
            mac_busy <= 1'b0;
            mac_phase <= 1'b0;
            sum_valid <= 1'b1;
